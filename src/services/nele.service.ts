...
export const transcribeAudio = async (
  ...
  const response = await apiService.getClient().post<{ text: string }>(
    '/api/nele/transcribe',
    formData,
    {
      headers: {
...
/**
 * Matches a company from the transcription using backend API
 */
...
/**
 * Processes and enhances the transcribed text using backend API
 */
